...
minetest.register_tool("fire:flint_and_steel", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pt.type == "node" then
			...
			if nodedef.on_ignite
					and not minetest.is_protected(pt.under, player_name) then
				nodedef.on_ignite(pt.under, user)
			elseif minetest.get_item_group(node_under, "flammable") >= 1
					and not minetest.is_protected(pt.above, player_name) then
...
minetest.override_item("default:coalblock", {
	...
	on_ignite = function(pos, igniter)
		...
		local player_name = igniter and igniter:get_player_name()
		if player_name and minetest.is_protected(flame_pos, player_name) then
			minetest.chat_send_player(player_name, "This area is protected")
		elseif minetest.get_node(flame_pos).name == "air" then
